...
CREATE TABLE `admin_app`  (
  ...
  `app_api` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '当前应用允许请求的全部API接口',
  ...
  `app_api_show` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '前台样式显示所需数据格式',
...
CREATE TABLE `admin_app_group`  (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组说明',
...
CREATE TABLE `admin_list`  (
  ...
  `returnStr` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '返回数据示例',
...
CREATE TABLE `admin_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 121 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '目录信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `admin_user_action`  (
  ...
  `data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户提交的数据',
  `url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '操作URL',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 643 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户操作日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `admin_user_data`  (
  ...
  `headImg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户头像',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `admin_user_data` VALUES (1, 13, 2130706433, 1560567066, '1', '');
...
CREATE TABLE `zj_basic_conf`  (
  ...
  `value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配置值',
...
INSERT INTO `zj_basic_conf` VALUES (3, 'website', 'http://localhost:8080/#/Register', NULL);
...
-- ----------------------------
INSERT INTO `zj_commission` VALUES (14, 1, 2, 22, 5, 2, '2019-06-15 10:12:34', '2019-06-15 10:12:34', 0);
INSERT INTO `zj_commission` VALUES (15, 2, 2, 3, 5, 2, '2019-06-15 10:12:34', '2019-06-15 10:12:34', 0);
INSERT INTO `zj_commission` VALUES (16, 1, 2, 22, 5, 2, '2019-06-15 10:15:10', '2019-06-15 10:15:10', 0);
INSERT INTO `zj_commission` VALUES (17, 2, 2, 3, 5, 2, '2019-06-15 10:15:10', '2019-06-15 10:15:10', 0);
...
CREATE TABLE `zj_commission_conf`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '佣金配置表' ROW_FORMAT = Fixed;
...
CREATE TABLE `zj_news`  (
  ...
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '新闻内容',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '{\"name\":\"状态\",\"value\":{\"0\":\"关闭\",\"1\":\"开启\"}}',
  `gmt_create` datetime(0) NOT NULL DEFAULT current_timestamp COMMENT '创建时间',
  `gmt_modified` datetime(0) NOT NULL DEFAULT current_timestamp ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`news_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '新闻表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '新闻类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `zj_task`  (
  ...
  `step` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '任务步骤',
  `show_img` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '图片展示',
  `take_care` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '注意事项',
  ...
  `submit_notice` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '提交说明',
  `submit_img` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '提交图片',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态(0:禁用;1:启用)',
  `gmt_create` datetime(0) NOT NULL DEFAULT current_timestamp COMMENT '创建时间',
  `gmt_modified` datetime(0) NOT NULL DEFAULT current_timestamp ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
...
INSERT INTO `zj_task` VALUES (2, 1, '【百度口碑】好评即可不下载', 100, 10, 3, '2019-06-30', 72, 30, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 10:17:58', 0);
...
-- Records of zj_user
-- ----------------------------
INSERT INTO `zj_user` VALUES (2, 3, 0, '2222', '2222', 'https://wx.qlogo.cn/mmopen/vi_32/94FG2F7ADdrbWF8Hlml5fERlibf4pjlthU0bAAlyZ3gNyZbOiaWXQWZA2ETciaCxJVLKGX2B8P7SiaSfusFJQUlvpA/132', NULL, '18328607281', 'e10adc3949ba59abbe56e057f20f883e', NULL, 22, '2019-06-14 03:26:20', '2019-06-15 10:15:10', 0);
INSERT INTO `zj_user` VALUES (3, 0, 0, '3333', '3333', 'https://wx.qlogo.cn/mmopen/vi_32/h3GVU1Iz7BaOmSSK6NrSBOibq9BzPMo4f4Gaic5pIS95CGMJEMouJQEjjSNPfjqbc11ibicnKJNqicFlLJatGQQNx2g/132', NULL, '13412341234', 'e10adc3949ba59abbe56e057f20f883e', NULL, 3, '2019-06-14 03:42:02', '2019-06-15 10:15:10', 0);
INSERT INTO `zj_user` VALUES (5, 2, 3, '1234', '4444', 'https://wx.qlogo.cn/mmopen/vi_32/h3GVU1Iz7BaOmSSK6NrSBOibq9BzPMo4f4Gaic5pIS95CGMJEMouJQEjjSNPfjqbc11ibicnKJNqicFlLJatGQQNx2g/132', NULL, '13512341234', 'e10adc3949ba59abbe56e057f20f883e', NULL, 100, '2019-06-14 05:53:03', '2019-06-15 10:15:10', 0);
INSERT INTO `zj_user` VALUES (6, 3, 0, '3334', '惠元财富会员3334', NULL, NULL, '13612341234', 'e10adc3949ba59abbe56e057f20f883e', NULL, 0, '2019-06-15 10:46:41', '2019-06-15 10:46:41', 0);
INSERT INTO `zj_user` VALUES (7, 6, 3, '3335', '惠元财富会员3335', NULL, NULL, '13712341234', 'e10adc3949ba59abbe56e057f20f883e', NULL, 0, '2019-06-15 11:21:40', '2019-06-15 11:21:40', 0);
...
-- ----------------------------
INSERT INTO `zj_user_income` VALUES (1, 3, 1, 1900, '2019-06-14 03:58:46', '2019-06-14 03:58:46', 0);
INSERT INTO `zj_user_income` VALUES (14, 5, 2, 100, '2019-06-15 10:12:34', '2019-06-15 10:12:34', 0);
INSERT INTO `zj_user_income` VALUES (15, 5, 2, 100, '2019-06-15 10:15:10', '2019-06-15 10:15:10', 0);
...
-- ----------------------------
INSERT INTO `zj_user_notice` VALUES (1, 6, '12', '123123123', 1, '2019-06-14 04:34:54', '2019-06-15 11:19:57', 0);
...
CREATE TABLE `zj_user_task`  (
  ...
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户id',
  `task_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '任务id',
  `submit_img` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '上传图片',
  `submit_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '上传文本',
...
INSERT INTO `zj_user_task` VALUES (11, 5, 2, NULL, NULL, '2019-06-15 02:27:26', '2019-06-15 10:15:10', 2, '2019-06-14 16:57:00', '2019-06-15 10:15:10', 0);
INSERT INTO `zj_user_task` VALUES (16, 3, 1, NULL, NULL, NULL, NULL, 4, '2019-06-14 19:33:55', '2019-06-14 19:34:21', 0);
INSERT INTO `zj_user_task` VALUES (4, 3, 2, NULL, NULL, '2019-06-14 15:54:06', '2019-06-15 10:17:58', 3, '2019-06-14 16:11:00', '2019-06-15 10:17:58', 0);
...
CREATE TABLE `zj_withdraw`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '提现表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of zj_withdraw
-- ----------------------------
INSERT INTO `zj_withdraw` VALUES (1, 3, 9900, 1, '123123', 1, '2019-06-14 04:39:44', '2019-06-14 04:39:44', 0);
INSERT INTO `zj_withdraw` VALUES (2, 3, 2000, 1, '123123123', 0, '2019-06-15 09:17:03', '2019-06-15 09:30:01', 0);
INSERT INTO `zj_withdraw` VALUES (3, 3, 3000, 1, '123', 2, '2019-06-15 09:33:20', '2019-06-15 09:47:03', 0);
INSERT INTO `zj_withdraw` VALUES (4, 3, 2000, 1, '123', 2, '2019-06-15 09:48:56', '2019-06-15 09:49:24', 0);
INSERT INTO `zj_withdraw` VALUES (5, 3, 2300, 1, '23', 0, '2019-06-15 09:49:33', '2019-06-15 09:49:33', 0);
INSERT INTO `zj_withdraw` VALUES (6, 3, 2600, 1, '11', 1, '2019-06-15 09:50:14', '2019-06-15 09:50:28', 0);
...
CREATE TABLE `zj_withdraw_way`  (
  ...
  `notice` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '提现备注',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态(0:禁用;1:启用)',
  `gmt_create` datetime(0) NOT NULL DEFAULT current_timestamp COMMENT '创建时间',
  `gmt_modified` datetime(0) NOT NULL DEFAULT current_timestamp ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
