...
CREATE TABLE `admin_user_action`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1632 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户操作日志' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `admin_user_data` VALUES (1, 59, 1974329005, 1560958858, '1', '');
...
CREATE TABLE `zj_basic_conf`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '基本配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `zj_commission`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '佣金表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '新闻类型表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of zj_user
-- ----------------------------
INSERT INTO `zj_user` VALUES (41, 0, 0, '1136', 'Redemption', 'http://thirdwx.qlogo.cn/mmopen/vi_32/kZWw8VUrXAybjiaiaPqH3TTQcjj2RKxwrBd76TkZQ6UJiaWOOfNjSekbrzGlIYk3UPiaibvQRKLnXcnudXelF1H86gg/132', 'oiZ5b1G6PY_Mh1CfYxnn0H3eoyiw', '', '', NULL, 0, '2019-06-18 20:32:20', '2019-06-19 23:31:46', 0);
INSERT INTO `zj_user` VALUES (44, 0, 0, '1137', '寻青', 'http://thirdwx.qlogo.cn/mmopen/vi_32/perebwOz2QXwUxiaCjqbtPRICScFna2YuIP4E44dAJwGDLAg7icmKgKsfBaJ7iaDL0SkjibgPia8Fj9vUEUKxbrD9Bw/132', 'oiZ5b1O59gHzxxhUsvo3YaJFonnQ', '', '', NULL, 0, '2019-06-19 23:31:49', '2019-06-19 23:31:49', 0);
...
CREATE TABLE `zj_user_income`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户收入表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `zj_user_task`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户任务表' ROW_FORMAT = Dynamic;
