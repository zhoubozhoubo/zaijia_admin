...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用于维护接口信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `admin_user_action`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 892 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户操作日志' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `admin_user_data` VALUES (1, 26, 3748151435, 1560619769, '1', '');
...
-- ----------------------------
INSERT INTO `zj_banner` VALUES (1, '1', 'http://jianzhi.hmdog.com/upload/20190615/3d82c6f02d254f2ef918d8466bf5b91f.jpg', 'http://www.baidu.com', 0, 1, '2019-06-14 01:38:44', '2019-06-16 01:36:08', 0);
INSERT INTO `zj_banner` VALUES (2, '2', 'http://jianzhi.hmdog.com/upload/20190615/895ce50f07b815b6553584a41bd6e27c.jpeg', 'http://www.baidu.com', 0, 1, '2019-06-14 01:38:51', '2019-06-16 01:36:08', 0);
INSERT INTO `zj_banner` VALUES (3, '3', 'http://jianzhi.hmdog.com/upload/20190615/9588c329d7479539df60b34d4ef9c3b4.jpeg', 'http://www.baidu.com', 0, 1, '2019-06-14 01:38:58', '2019-06-16 01:36:09', 0);
INSERT INTO `zj_banner` VALUES (4, '4', 'http://jianzhi.hmdog.com/upload/20190615/473ec76009c2b0baacb038a995972c84.jpeg', 'http://www.baidu.com', 0, 1, '2019-06-14 01:39:04', '2019-06-16 01:36:10', 0);
...
INSERT INTO `zj_basic_conf` VALUES (2, 'customer', '客服 QQ：2332155808%,%合作邮箱：2332155808@qq.com', NULL);
INSERT INTO `zj_basic_conf` VALUES (3, 'website', 'http://jianzhi.hmdog.com:8003/#', NULL);
...
CREATE TABLE `zj_commission`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '佣金表' ROW_FORMAT = Dynamic;
...
-- Records of zj_link
-- ----------------------------
INSERT INTO `zj_link` VALUES (1, '1', 'http://jianzhi.hmdog.com/upload/20190616/87caddcece20808e2e7329b974769aea.jpg', 'http://www.baidu.com', 1, 1, '2019-06-14 01:40:02', '2019-06-16 01:38:27', 0);
INSERT INTO `zj_link` VALUES (2, '2', 'http://jianzhi.hmdog.com/upload/20190615/7df54909c2767a01f03de9e7c23c27bf.jpeg', 'http://www.baidu.com', 0, 1, '2019-06-14 01:40:07', '2019-06-15 15:56:01', 0);
INSERT INTO `zj_link` VALUES (3, '3', 'http://jianzhi.hmdog.com/upload/20190615/f52792f7f34c6ec284d94ba39823cbca.jpeg', 'http://www.baidu.com', 0, 1, '2019-06-14 01:40:12', '2019-06-15 15:56:10', 0);
INSERT INTO `zj_link` VALUES (4, '4', 'http://jianzhi.hmdog.com/upload/20190615/fe64f99f7085d3a4265c2db423d5c988.jpeg', 'http://www.baidu.com', 0, 1, '2019-06-14 01:40:18', '2019-06-15 15:56:20', 0);
...
-- ----------------------------
INSERT INTO `zj_news_type` VALUES (1, '社会', 'http://127.0.0.1:8001/upload/20190614/93775dab78f8b737a9f11690d90e71df.png', '', 0, 1, '2019-06-14 01:40:52', '2019-06-15 00:34:52', 0);
INSERT INTO `zj_news_type` VALUES (2, '娱乐', 'http://127.0.0.1:8001/upload/20190614/14b206df4643b99b3888d43ea8cd2ad4.png', '', 0, 1, '2019-06-14 01:40:59', '2019-06-15 00:35:08', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '任务表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of zj_task
-- ----------------------------
INSERT INTO `zj_task` VALUES (1, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 6, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 17:34:15', 0);
INSERT INTO `zj_task` VALUES (2, 2, '【百度口碑】好评即可不下载不下载', 100, 10, 3, '2019-06-30', 72, 30, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 21:34:35', 0);
INSERT INTO `zj_task` VALUES (3, 3, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:27', 0);
INSERT INTO `zj_task` VALUES (4, 4, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:29', 0);
INSERT INTO `zj_task` VALUES (5, 5, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:30', 0);
INSERT INTO `zj_task` VALUES (6, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:15', 0);
INSERT INTO `zj_task` VALUES (7, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:34', 0);
INSERT INTO `zj_task` VALUES (8, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:35', 0);
INSERT INTO `zj_task` VALUES (9, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:35', 0);
INSERT INTO `zj_task` VALUES (10, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:36', 0);
INSERT INTO `zj_task` VALUES (11, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:38', 0);
INSERT INTO `zj_task` VALUES (12, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:37', 0);
INSERT INTO `zj_task` VALUES (13, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:39', 0);
INSERT INTO `zj_task` VALUES (14, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:40', 0);
INSERT INTO `zj_task` VALUES (15, 1, '【百度口碑】好评即可不下载不下载', 100, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:42', 0);
INSERT INTO `zj_task` VALUES (16, 1, '【百度口碑】好评即可不下载不下载', 900, 10, 0, '2019-06-30', 72, 2, 1, 110000, 110100, 'www.baidu.com', '（评语请加微信号377047364，备注：百度口碑+你的手机品牌，客服通过你的好友验证发评语给你）%,%一定要加客服等客服给你评语在做任务，不是客服给的评语不合格%,%（复制注意事项中的链接到浏览器进入，点击登陆账号，给五星好评+评语+上传图片即可%,%（需要有百度账号，如已有账号，直接登录评价，如果没有自行注册一个号%,%一人只能评论一次，设置不限次数是因为怕有的超时没办法提交', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', '1、一个手机只能注册一次，注册过的用户不能再注册，新用户收到借条额度通过通知和成功借款的用户才有奖励；\n2、可以随意借一笔款，几天后还款，利息按日计算，红包可以抵扣利息；', 1, 1, '1、必须扫图中二维码；\n2、成功之后必须有当天赠送的卡券；', 'http://127.0.0.1:8001/upload/20190614/4c292520ae632633af81f9403a6e8576.png%,%http://127.0.0.1:8001/upload/20190614/48603eff30e52d9ac393854553703710.png', 1, '2019-06-14 01:51:25', '2019-06-15 16:10:41', 0);
...
CREATE TABLE `zj_task_type`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '任务类型表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of zj_task_type
-- ----------------------------
INSERT INTO `zj_task_type` VALUES (1, '游戏', 'http://jianzhi.hmdog.com/upload/20190615/719363d8fd98d8a16dc3128da458764a.jpeg', '', 0, 1, '2019-06-14 01:40:52', '2019-06-15 16:11:21', 0);
...
INSERT INTO `zj_task_type` VALUES (6, '聊天1', 'http://jianzhi.hmdog.com/upload/20190616/950284f2a941b713f96e2fc9c33fd0bc.jpg', '', 0, 1, '2019-06-16 00:04:09', '2019-06-16 00:04:09', 0);
...
-- Records of zj_user
-- ----------------------------
INSERT INTO `zj_user` VALUES (2, 3, 0, '1111', '惠元财富会员1111', 'https://wx.qlogo.cn/mmopen/vi_32/94FG2F7ADdrbWF8Hlml5fERlibf4pjlthU0bAAlyZ3gNyZbOiaWXQWZA2ETciaCxJVLKGX2B8P7SiaSfusFJQUlvpA/132', NULL, '18328607281', 'e10adc3949ba59abbe56e057f20f883e', NULL, 22, '2019-06-14 03:26:20', '2019-06-15 15:40:09', 0);
...
INSERT INTO `zj_user` VALUES (9, 0, 0, '1113', '惠元财富会员1113', NULL, NULL, '18328607282', 'e10adc3949ba59abbe56e057f20f883e', NULL, 0, '2019-06-15 16:35:20', '2019-06-15 16:35:20', 0);
...
INSERT INTO `zj_user` VALUES (11, 0, 0, '1115', '惠元财富会员1115', NULL, NULL, '13528798018', '6249c3f95d54736c0b65f6394eab1a20', NULL, 0, '2019-06-15 16:41:44', '2019-06-15 16:41:44', 0);
...
CREATE TABLE `zj_user_income`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户收入表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `zj_user_task`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户任务表' ROW_FORMAT = Dynamic;
...
INSERT INTO `zj_user_task` VALUES (21, 9, 1, NULL, NULL, NULL, NULL, 0, '2019-06-15 16:45:35', '2019-06-15 16:45:35', 0);
INSERT INTO `zj_user_task` VALUES (22, 11, 2, NULL, NULL, NULL, NULL, 4, '2019-06-15 16:48:59', '2019-06-15 21:34:32', 0);
INSERT INTO `zj_user_task` VALUES (23, 11, 1, '', '', '2019-06-15 23:40:38', NULL, 1, '2019-06-15 16:52:32', '2019-06-15 23:40:38', 0);
...
INSERT INTO `zj_user_task` VALUES (26, 2, 1, '', '', '2019-06-15 17:16:28', NULL, 1, '2019-06-15 17:11:31', '2019-06-15 17:16:29', 0);
...
CREATE TABLE `zj_withdraw`  (
  ...
  `is_delete` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除(0:未删除;1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '提现表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `zj_withdraw_way` VALUES (1, '支付宝提现', 2000, 10000, '您所提现金额为税前金额，支付宝账号信息需要与身份证信息一致，所提交信息通过审核后，我们将在48小时内转入您的支付宝账号，请确保支付宝账号可查找，提现金额起点为20元。', 1, '2019-06-14 04:40:06', '2019-06-15 08:51:35', 0);
